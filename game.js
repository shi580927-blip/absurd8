...
$('rewardedAd').addEventListener('click',mainRewardedAdClick);
$('adClose').addEventListener('click',e=>{e.stopPropagation();peekAdDrawer()});
$('adPeek').addEventListener('click',()=>{$('adDrawer').classList.contains('peek')?showAdDrawer():mainRewardedAdClick()});

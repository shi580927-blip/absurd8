...
const houses=[
  {level:3,name:['Коробка эконом-класса','Economy-Class Box'],img:'assets/images/houses/house-stage-1.png'},
  {level:5,name:['Однокомнатная премЯум-класса','One-Room Purr-mium Home'],img:'assets/images/houses/house-stage-2.png'},
  {level:7,name:['Домик с личной когтеточкой','Home with a Private Scratcher'],img:'assets/images/houses/house-stage-3.png'},
  {level:9,name:['Вертикальная недвижимость','Vertical Real Estate'],img:'assets/images/houses/house-stage-4.png'},
  {level:11,name:['Трон-резиденция Шефа','Chef’s Throne Residence'],img:'assets/images/houses/house-stage-5.png'},
  {level:13,name:['Дворец Повелителя отдыха','Palace of the Lord of Rest'],img:'assets/images/houses/house-stage-6.png'}
];
const bowlImages=[
...
const carpetFood=[
  {img:4,name:'Икра для важных переговоров',minutes:3,cost:14,x:3,y:68,w:13,reaction:'judging',serve:['Икра соответствует должности.','The caviar is appropriate for my position.'],refuseReaction:'stunned',refuse:['Без хлеба. И без свидетелей.','No bread. And no witnesses.']},
  {img:16,name:'Стратегический запас консервов',minutes:4,cost:20,x:82,y:69,w:13,reaction:'innocent',serve:['Я ничего не трогал.','I did not touch anything.'],refuseReaction:'judging',refuse:['Это запас. Его нельзя просто так съесть.','These are reserves. One cannot simply eat them.']},
  {img:12,name:'Консерва особой важности',minutes:4,cost:24,x:15,y:76,w:12,reaction:'stunned',serve:['Одна? Смелое решение.','Only one? A bold decision.'],refuseReaction:'judging',refuse:['Важность есть. Аппетита нет.','It is important. It is not appetizing.']},
  {img:11,name:'Дорада по высшему разряду',minutes:5,cost:32,x:70,y:77,w:16,reaction:'hunting',serve:['О, а вот любимая рыбка.','Oh, my favorite fish.'],refuseReaction:'pleading',refuse:['Она ещё на меня смотрит. Уберите.','It is still looking at me. Take it away.']},
  {img:6,name:'Парадная курица',minutes:5,cost:38,x:2,y:52,w:14,reaction:'pleading',serve:['Люблю курочку. Можно было сразу нести две.','I love chicken. You could have brought two.'],refuseReaction:'innocent',refuse:['Какая жареная курица? Впервые слышу.','What roast chicken? Never heard of it.']},
  {img:10,name:'Большая рыбная тарелка',minutes:6,cost:48,x:85,y:53,w:12,reaction:'hypnosis',serve:['Рыба хорошая. А вторая где?','The fish is good. Where is the second one?'],refuseReaction:'judging',refuse:['Большая тарелка не делает рыбу больше.','A large plate does not make the fish larger.']},
  {img:3,name:'Фиолетовая консерва',minutes:4,cost:28,x:24,y:66,w:11,reaction:'stunned',serve:['Фиолетовая. Значит, секретная.','Purple. Therefore classified.'],refuseReaction:'shock',refuse:['Фу, уберите. Бэ-э.','Ew, take it away. Yuck.']},
  {img:8,name:'Лосось для руководства',minutes:6,cost:60,x:63,y:65,w:14,reaction:'hunting',serve:['Шеф одобряет улов. Оставьте целиком.','Chef approves the catch. Leave it whole.'],refuseReaction:'judging',refuse:['Руководство ожидало другой лосось.','Management expected a different salmon.']},
  {img:9,name:'Фуршет «Девять жизней»',minutes:7,cost:75,x:40,y:74,w:13,reaction:'shock',serve:['Это всё мне? Можете не отвечать.','Is all this for me? No need to answer.'],refuseReaction:'pleading',refuse:['Девять жизней, а желудок один. Какая несправедливость.','Nine lives, but only one stomach. How unfair.']},
  {img:'buffets/sushi-ship-full',asset:'assets/images/buffets/sushi-ship-full.webp',name:'Суши-корабль Его Наглейшества',minutes:3,cost:140,buffet:true,premium:true,clickMultiplier:2,stageClicks:[14,34],revealLevel:8,adLevel:8,reaction:'shock',serve:['Это всё мне? Можете не отвечать.','Is all this for me? No need to answer.']},
  {asset:'assets/images/premium-dishes/royal-lobster.webp',name:'Королевский омар',minutes:6,cost:190,premium:true,revealLevel:9,adLevel:9,reaction:'hunting',serve:['Омар прибыл. Корона остаётся у меня.','The lobster has arrived. The crown stays with me.'],refuseReaction:'judging',refuse:['Королевский — это про меня. Омар может подождать.','Royal refers to me. The lobster can wait.']},
  {asset:'assets/images/premium-dishes/imperial-sturgeon.webp',name:'Императорский осётр',minutes:7,cost:250,premium:true,revealLevel:10,adLevel:10,reaction:'hypnosis',serve:['Осётр принят в высшее общество.','The sturgeon has been admitted to high society.'],refuseReaction:'stunned',refuse:['Императорский? Предъявите родословную.','Imperial? Show me its pedigree.']},
  {asset:'assets/images/premium-dishes/shrimp-caviar-tower.webp',name:'Башня из креветок с икрой',minutes:7,cost:330,premium:true,revealLevel:11,adLevel:11,reaction:'shock',serve:['Башня устойчива. Пока я не начал.','The tower is stable. Until I begin.'],refuseReaction:'pleading',refuse:['Слишком высокая. Подвиньте поближе.','Too tall. Move it closer.']},
  {asset:'assets/images/premium-dishes/pearl-shell.webp',name:'Перламутровая раковина',minutes:8,cost:430,premium:true,revealLevel:11,adLevel:11,reaction:'innocent',serve:['Жемчуг оставьте. Я веду учёт.','Leave the pearls. I keep records.'],refuseReaction:'judging',refuse:['Раковина красивая. Еда где?','The shell is beautiful. Where is the food?']},
  {asset:'assets/images/premium-dishes/crystal-sashimi-fish.webp',name:'Хрустальная рыба с сашими',minutes:8,cost:560,premium:true,revealLevel:13,adLevel:13,reaction:'hunting',serve:['Хрусталь не есть. Сашими — дважды.','Do not eat the crystal. Double the sashimi.'],refuseReaction:'stunned',refuse:['Она прозрачная. Это подозрительно.','It is transparent. Suspicious.']},
  {asset:'assets/images/premium-dishes/golden-tier-stand.webp',name:'Золотая этажерка',minutes:9,cost:720,premium:true,revealLevel:12,adLevel:12,reaction:'hypnosis',serve:['Три этажа. Наконец разумная порция.','Three tiers. Finally, a sensible portion.'],refuseReaction:'judging',refuse:['Золото одобряю. Комплектацию — нет.','Gold approved. Assortment rejected.']},
  {asset:'assets/images/premium-dishes/caviar-palace.webp',name:'Икорный дворец',minutes:10,cost:920,premium:true,revealLevel:13,adLevel:13,reaction:'shock',serve:['Дворец принят. Заселяюсь немедленно.','Palace accepted. Moving in immediately.'],refuseReaction:'innocent',refuse:['Дворец маловат. Я похож на арендатора?','The palace is too small. Do I look like a tenant?']},
  {asset:'assets/images/premium-dishes/truffle-tuna.webp',name:'Тунец с трюфелями',minutes:10,cost:1180,premium:true,revealLevel:13,adLevel:13,reaction:'hunting',serve:['Тунец найден. Трюфели тоже не пропадут.','Tuna found. The truffles will not go to waste either.'],refuseReaction:'judging',refuse:['Трюфели отвлекают от главного.','The truffles distract from what matters.']},
  {asset:'assets/images/premium-dishes/royal-seafood-feast.webp',name:'Королевский морской фуршет',minutes:12,cost:1500,premium:true,revealLevel:14,adLevel:14,reaction:'shock',serve:['Закройте двери. Начинается государственный приём.','Close the doors. The state reception is beginning.'],refuseReaction:'pleading',refuse:['Гостей не будет? Тогда придётся справляться самому.','No guests? Then I shall have to manage alone.']}
];
...
const catReactionImages={happy:'assets/images/reaction-happy.webp',fussy:'assets/images/reaction-fussy.webp',stunned:'assets/images/reactions/reaction-stunned.webp',hypnosis:'assets/images/reactions/reaction-hypnosis.webp',shock:'assets/images/reactions/reaction-shock.webp',pleading:'assets/images/reactions/reaction-pleading.webp',hunting:'assets/images/reactions/reaction-hunting.webp',judging:'assets/images/reactions/reaction-judging.webp',innocent:'assets/images/reactions/reaction-innocent.webp'};
const catReactionNames={happy:['Довольный Шеф','Satisfied Chef'],fussy:['Привередливый Шеф','Fussy Chef'],stunned:['Ошеломлённый Шеф','Stunned Chef'],hypnosis:['Гипноз пустой миски','Empty-bowl hypnosis'],shock:['Удивлённый Шеф','Surprised Chef'],pleading:['Умоляющий Шеф','Pleading Chef'],hunting:['Охотничий взгляд Шефа','Chef on the hunt'],judging:['Осуждающий Шеф','Judging Chef'],innocent:['Невиновный Шеф','Innocent Chef']};
...
function activePremiumDish(){const now=Date.now();let active=null;carpetFood.forEach((treat,index)=>{const until=state.treatUntil[index]||0;if(treat.premium&&!treat.buffet&&until>now&&(!active||until>active.until))active={index,treat,until}});return active}
...
function render(updatePanels=false){
  ...
  const houseStage=houses.findLastIndex(house=>house.level<=li+1),house=houses[houseStage],houseDecor=$('houseDecor');
  if(house&&houseDecor.getAttribute('src')!==house.img)houseDecor.src=house.img;
  houseDecor.alt=house?(gameLanguage==='en'?house.name[1]:house.name[0]):'';
  houseDecor.classList.toggle('visible',!!house);
  if(houseStage!==renderedHouseStage){renderedHouseStage=houseStage;if(house){houseDecor.classList.remove('arriving');void houseDecor.offsetWidth;houseDecor.classList.add('arriving');setTimeout(()=>houseDecor.classList.remove('arriving'),950)}}
...
$('treats').addEventListener('click',e=>{const button=e.target.closest('.treat-card');if(!button)return;updateCare();const index=+button.dataset.treat,treat=carpetFood[index],name=itemName(treat),cost=treatPrice(treat);if((state.treatUntil[index]||0)>Date.now()){$('phrase').textContent=L(`«${name}» уже подано. Сначала Шеф должен закончить трапезу.`,`“${name}” is already served. Chef must finish this course first.`);return}if(treat.buffet&&activeBuffet()){$('phrase').textContent=L('Один фуршет за раз. Шеф настаивает на порядке подачи.','One buffet at a time. Chef insists on proper service.');return}if(state.food<cost){playSound('error',.45);$('phrase').textContent=L(`Для «${name}» не хватает ${format(cost-state.food)} рыбов.`,`You need ${format(cost-state.food)} more fish for “${name}”.`);return}if(!treat.buffet&&state.care.hunger>75&&Math.random()<.18){const refusal=treatText(treat,'refuse')||L('Нет. Просто нет.','No. Just no.');playSound('cat-soft',.6);$('cat').classList.add('refuses');$('bowl').classList.add('refused');$('phrase').textContent=refusal;showCatThought(treat.refuseReaction||'fussy',refusal);setTimeout(()=>{$('cat').classList.remove('refuses');$('bowl').classList.remove('refused')},850);trackEvent('treat_refused',{treat:treat.name,reaction:treat.refuseReaction||'fussy'});return}state.food-=cost;state.care.hunger=Math.min(100,state.care.hunger+10);state.care.mood=Math.min(100,state.care.mood+4);state.treatUntil[index]=Date.now()+treat.minutes*60000;if(treat.buffet)state.buffetClicks[index]=0;$('cat').classList.add('feasting');$('bowl').classList.add('served');setTimeout(()=>{$('cat').classList.remove('feasting');$('bowl').classList.remove('served')},650);playFeedSound();const serving=treatText(treat,'serve')||L(`«${name}» подано.`,`“${name}” has been served.`);$('phrase').textContent=serving;showCatThought(treat.reaction||'happy',serving);if(treat.buffet)playSound('cat-soft',.62);else setTimeout(()=>playPurr(),450);trackEvent('treat_served',{treat:treat.name,minutes:treat.minutes,reaction:treat.reaction||'happy'});save();render(true)});
...
function layoutProfile(){if(innerWidth>=900&&innerWidth/innerHeight>=4/3)return'desktop';if(innerWidth>=760)return'tablet';if(innerWidth<=390)return'mobile-small';return'mobile-large'}
const layoutKey=()=>`absurd8-layout-v6-${layoutProfile()}`;
const defaultLayouts={
  desktop:{certificateDecor:{z:-4,hidden:false,left:74.12,top:32.23,width:9.99},grandmaHelper:{z:0,hidden:false,left:22.36,top:31.89,width:10.09},mouseDecor:{z:0,hidden:false,left:1.44,top:0,width:4.91},boxDecor:{z:-5,hidden:false,left:5.26,top:57.81,width:11.65},houseDecor:{z:-5,hidden:false,left:57.35,top:45.32,width:9.99},chefHelper:{z:0,hidden:false,left:81.68,top:37.1,width:18.32},deliveryHelper:{z:2,hidden:false,left:0,top:43.01,width:18.19},laserDecor:{z:0,hidden:false,left:21.9,top:97,width:3},cat:{z:0,hidden:false,dx:-1.37,dy:6.92,scale:.8},bowl:{z:0,hidden:false,dx:-.42,dy:-.46,scale:1.4},foodProp1:{z:0,hidden:false,left:23.48,top:87.11,width:5},foodProp2:{z:0,hidden:false,left:21.74,top:70.8,width:5},foodProp3:{z:0,hidden:false,left:70.8,top:85.78,width:4},foodProp4:{z:-1,hidden:false,left:76.76,top:82.89,width:14},foodProp5:{z:0,hidden:false,left:25.9,top:63.26,width:15.99},foodProp6:{z:0,hidden:false,left:60.26,top:62.74,width:13.99},foodProp7:{z:0,hidden:false,left:17.62,top:75.47,width:5},foodProp8:{z:-1,hidden:false,left:3.39,top:83.35,width:9.99},foodProp9:{z:0,hidden:false,left:72.11,top:73.1,width:11},foodPileDecor:{z:-5,hidden:false,left:28.56,top:37.86,width:16.97},roomEvent:{z:0,hidden:false,dx:-14.43,dy:-25.29,scale:1},phrase:{z:-1,hidden:false,dx:0,dy:0,scale:1}},
  tablet:{certificateDecor:{left:52.79,top:.32,width:19.99},grandmaHelper:{left:6.84,top:13.35,width:24.09},mouseDecor:{left:0,top:12.51,width:12},boxDecor:{left:69.96,top:75.19,width:30.04},houseDecor:{z:-2,left:0,top:60,width:34},chefHelper:{left:63.67,top:17.82,width:36.33},deliveryHelper:{left:1.64,top:54.73,width:34.21},laserDecor:{left:34.28,top:93.7,width:1.74},cat:{dx:-1.61,dy:2.92,scale:1},bowl:{dx:1.49,dy:.55,scale:1.1},foodProp2:{left:82.36,top:59.04,width:13},foodProp4:{left:49.29,top:79.11,width:22},foodProp5:{left:2,top:52,width:20},foodProp6:{left:5.88,top:75.6,width:26},foodProp7:{left:70.85,top:57.92,width:11},foodProp8:{left:62.44,top:71.75,width:18},foodProp9:{left:32.66,top:80.41,width:15},foodPileDecor:{left:26.78,top:7.49,width:48.98}},
  'mobile-small':{certificateDecor:{left:39.93,top:2.69,width:36},cat:{dx:-5.96,dy:7.75,scale:.7},bowl:{dx:-1.25,dy:-2.05,scale:.8},mouseDecor:{left:0,top:19.07,width:16.29},boxDecor:{left:67.96,top:68.17,width:32.04},houseDecor:{z:-2,left:0,top:62,width:36},chefHelper:{left:59.68,top:20.16,width:40.32},grandmaHelper:{left:6.71,top:25.44,width:26.08},deliveryHelper:{left:0,top:60.3,width:36.2},laserDecor:{left:34.28,top:93.7,width:1.74},foodProp3:{left:4.36,top:80.08,width:12},foodProp4:{left:75.34,top:88.12,width:24},foodProp5:{left:0,top:55.61,width:20},foodProp6:{left:11.97,top:72.72,width:26},foodProp7:{left:82.15,top:56.11,width:11},foodProp8:{left:64.13,top:67.31,width:18},foodProp9:{left:54.82,top:79.15,width:21},foodPileDecor:{left:27.49,top:20,width:51}},
  'mobile-large':{certificateDecor:{left:43,top:1.5,width:32},cat:{dx:-2,dy:6.52,scale:.82},bowl:{dx:.76,dy:1.9,scale:.88},mouseDecor:{left:0,top:16.5,width:14.5},boxDecor:{left:70,top:68,width:30},houseDecor:{z:-2,left:0,top:60,width:34},chefHelper:{left:62,top:20,width:38},grandmaHelper:{left:7,top:25,width:25},deliveryHelper:{left:0,top:60,width:34},laserDecor:{left:34.28,top:93.7,width:1.74},foodProp3:{left:4,top:80,width:10},foodProp4:{left:76,top:87,width:22},foodProp5:{left:0,top:54,width:18},foodProp6:{left:12,top:72,width:24},foodProp7:{left:81,top:55,width:10},foodProp8:{left:64,top:67,width:17},foodProp9:{left:55,top:79,width:19},foodPileDecor:{left:28.5,top:17,width:49}}
};

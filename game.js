...
const carpetFood=[
  ...
  {asset:'assets/images/premium-dishes/pearl-shell.webp',name:'Перламутровая раковина',minutes:8,cost:430,premium:true,revealLevel:11,adLevel:11,reaction:'innocent',serve:['Жемчуг оставьте. Я веду учёт.','Leave the pearls. I keep records.'],refuseReaction:'fussy',refuse:['Раковина красивая. Еда где?','The shell is beautiful. Where is the food?']},
...
const catReactionImages={happy:'assets/images/reactions/reaction-happy.webp',fussy:'assets/images/reactions/reaction-fussy.webp',stunned:'assets/images/reactions/reaction-stunned.webp',shock:'assets/images/reactions/reaction-shock.webp',pleading:'assets/images/reactions/reaction-pleading.webp',hunting:'assets/images/reactions/reaction-hunting.webp',judging:'assets/images/reactions/reaction-judging.webp',innocent:'assets/images/reactions/reaction-innocent.webp'};

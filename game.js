...
let thoughtTimer,delayedThoughtTimer,thoughtSide=false,previousThoughtMessage='',thoughtBatchTimer,thoughtBatch={count:0,refused:false};
...
const layoutKey=()=>`absurd8-layout-v7-${layoutProfile()}`;
const defaultLayouts={
  desktop:{certificateDecor:{z:-5,hidden:false,left:23.18,top:0,width:9.99},grandmaHelper:{z:0,hidden:false,left:11.26,top:34.09,width:10.09},mouseDecor:{z:0,hidden:false,left:1.44,top:0,width:4.91},boxDecor:{z:-5,hidden:false,left:90.35,top:80.25,width:9.65},chefHelper:{z:0,hidden:false,left:79.69,top:25.8,width:22.31},deliveryHelper:{z:2,hidden:false,left:0,top:50.57,width:18.19},laserDecor:{z:0,hidden:false,left:21.9,top:97,width:3},cat:{z:0,hidden:false,dx:-1.05,dy:10.57,scale:.8},bowl:{z:0,hidden:false,dx:-.38,dy:2.14,scale:1.4},foodProp1:{z:0,hidden:false,left:23.48,top:87.11,width:5},foodProp2:{z:0,hidden:false,left:21.74,top:70.8,width:5},foodProp3:{z:0,hidden:false,left:70.8,top:85.78,width:4},foodProp4:{z:-1,hidden:false,left:76.76,top:82.89,width:14},foodProp5:{z:0,hidden:false,left:27.53,top:62.85,width:15.99},foodProp6:{z:0,hidden:false,left:60.26,top:62.74,width:13.99},foodProp7:{z:0,hidden:false,left:17.62,top:75.47,width:5},foodProp8:{z:-1,hidden:false,left:3.39,top:83.35,width:9.99},foodProp9:{z:0,hidden:false,left:55.71,top:69.24,width:13},foodPileDecor:{z:-5,hidden:false,left:28.14,top:39.1,width:14.97},roomEvent:{z:0,hidden:false,dx:-14.43,dy:-25.29,scale:1},phrase:{z:-1,hidden:false,dx:0,dy:0,scale:1}},

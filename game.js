...
function startZoomies(kind){
  ...
  pauseZoomiesAudio();zoomiesAudio=zoomiesAudioTracks[zoomiesPath.kind==='walls'?1:0];zoomiesAudio.currentTime=0;duckMusic(ZOOMIES_DURATION+1800);rampMusic(.015,120);syncZoomiesAudio();

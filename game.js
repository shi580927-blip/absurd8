...
const carpetFood=[
  ...
  {img:'buffets/sushi-ship-full',name:'Суши-корабль Его Наглейшества',minutes:3,cost:140,buffet:true,clickMultiplier:2,stageClicks:[14,34],revealLevel:8,adLevel:8,reaction:'shock',serve:['Это всё мне? Можете не отвечать.','Is all this for me? No need to answer.']}
];

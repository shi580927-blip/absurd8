...
function gameIsPaused(){return adPlaying||platformPaused||!brandIntroFinished||document.visibilityState==='hidden'||needsLandscape()}
...
function syncOrientation(){if(needsLandscape()){stopGameplay();stopAllSounds()}else{startGameplay();ensureMusic()}}

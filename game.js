...
const helperStageAtlasDefs={
  grandma:{
    ...
    frames:[
      ...
      {key:'grandma_03_home_roast',x:655,y:19,w:210,h:280},
...
function helperStageFrameUrl(kind,index){
  ...
  if(!def||!atlas||!def.ready||!frame)return null;

...
const soundExt='mp3';
const zoomiesAudioTracks=[1,2].map(()=>{const audio=new WebAudioTrack(`assets/audio/tygydyk-owner.${soundExt}?v=20260924-1`);audio.preload='auto';audio.volume=1;audio.loop=false;return audio});

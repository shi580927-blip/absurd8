...
const soundNames=['ui-click','feed','buy','error','level','reward','cat-food','cat-happy','cat-happy-2','cat-soft','toy-yarn','toy-mouse','toy-slipper','toy-feather','toy-fish'];
